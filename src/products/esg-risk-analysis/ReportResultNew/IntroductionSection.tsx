    ...
    <div class="mb-16 flex w-full flex-col"> 
      <div class="flex flex-col gap-2"> 
        <div x-data="{ 
          infoOpen: false, 
          blockOpen: false 
        }" x-show="(general === true)" class="flex flex-col rounded-sm py-4"> 
          ...
          <div class="lg:item-center flex flex-col gap-6 self-start lg:max-w-full lg:flex-row"> 
            <div class="flex gap-6 pt-4"> 
              <div class="prose lg:prose-lg hyphens-none"> 
                <p>Here you will find a risk analysis of the CSR Risk Check based on your selected products and/or countries. The analysis provides insights into potential social and environmental risks in your value chain.&nbsp;</p>
                <ul>
                  <li>The risks are in random order</li>
                  <li>The risks are divided into four themes: Fair business practices, Human rights &amp; ethics, Labour rights, environment&nbsp;</li>
                  <li>In the risks analysis you will also find recommendations on how to mitigate the various risks</li>
                  <li>We are constantly working on updating the database. However, it is possible that risks information is not yet available for certain categories, even though risks may occur.&nbsp;</li>
                  <li>&nbsp;The number of risks is not intended to prioritize nor does it indicate severity. We recommend conducting thorough research to fully identify risks in your supply chain, including engaging with your suppliers.</li>
                </ul> 
              </div> 
            </div> 
          </div> 
