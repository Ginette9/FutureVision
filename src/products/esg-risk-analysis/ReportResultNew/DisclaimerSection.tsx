...
export const DisclaimerSection: React.FC = () => {
  ...
  const sectionTitle = isZh ? '免责声明' : 'Disclaimer';
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center space-x-4 py-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">{isZh ? '重要法律与使用信息' : 'Important legal and usage information'}</p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-orange-800 mb-2">{isZh ? '重要提示' : 'Important Notice'}</h3>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <h3 className="text-xl font-medium text-gray-900">{isZh ? '法律声明' : 'Legal Disclaimer'}</h3>
            </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">{isZh ? '国际标准' : 'International Standards'}</h3>
          </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">{isZh ? '数据来源' : 'Data Sources'}</h3>
          </div>
          <p className="text-gray-700 text-sm leading-relaxed">
            {isZh
