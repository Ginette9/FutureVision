...
export const DisclaimerSection: React.FC = () => {
  ...
  const sectionTitle = language === 'zh-CN' ? '免责声明' : 'Disclaimer';
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center space-x-4 py-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">{language === 'zh-CN' ? '重要法律与使用信息' : 'Important legal and usage information'}</p>
        </div>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-orange-800 mb-2">{language === 'zh-CN' ? '重要提示' : 'Important Notice'}</h3>
                <p className="text-orange-700 text-sm leading-relaxed">
                  {language === 'zh-CN'
                    ? '本 ESG 风险检查仅供信息参考。用户使用本报告所产生的全部后果由其自行承担。对于重要商业决策，建议咨询具有资质的 ESG 专家。'
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <h3 className="text-xl font-medium text-gray-900">{language === 'zh-CN' ? '法律声明' : 'Legal Disclaimer'}</h3>
            </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">{language === 'zh-CN' ? '国际标准' : 'International Standards'}</h3>
          </div>
          <p className="text-gray-700 text-sm leading-relaxed">
            {language === 'zh-CN'
              ? '基于 OECD 指南与联合国商业与人权指导原则，确保与全球认可的 ESG 框架保持一致。'
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-xl p-6">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800">{language === 'zh-CN' ? '数据来源' : 'Data Sources'}</h3>
          </div>
          <p className="text-gray-700 text-sm leading-relaxed">
            {language === 'zh-CN'
              ? '信息来源于经核验的公开渠道，采用 ISO 3166 标准、联合国统计司分类与可靠性评估机制整理。'
