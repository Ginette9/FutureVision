...
export const AboutMvoSection: React.FC = () => {
  ...
  const sectionTitle = isZh ? toZhHK('关于我们') : 'About Us';
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center space-x-4 py-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">
            {isZh ? toZhHK('可持续咨询与 AI 驱动智能') : 'Sustainability consulting and AI-powered intelligence'}
          </p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl p-8 text-center">
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          <h3 className="text-xl font-semibold text-gray-900">{isZh ? toZhHK('准备好重新定义增长了吗？') : 'Ready to Transform Your Business?'}</h3>
          <p className="text-gray-600">
            {isZh
              ? toZhHK('了解我们的可持续咨询与 AI 智能如何助力您的企业实现可持续增长。')
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
            ...
            >
              {isZh ? toZhHK('访问 MSC 官网') : 'Visit MSC Website'}
            ...
            <a
              ...
              className="inline-flex items-center px-6 py-3 bg-gray-600 text-white font-medium rounded-lg hover:bg-gray-700 transition-colors"
            >
              {isZh ? toZhHK('探索 Future Vision') : 'Explore Future Vision'}
              <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
              </svg>
            </a>
